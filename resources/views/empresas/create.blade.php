    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-100">
                <form method="POST" action="{{ route('empresas.store') }}" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="identificacion_fiscal" class="block mt-1 w-full" type="text" name="identificacion_fiscal" :value="old('identificacion_fiscal')" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <x-input-label for="logo" :value="__('Logo (opcional)')" />
